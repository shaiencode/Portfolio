        ...
        <div className="projects-grid">
          <div className="project-card">
            ...
            <div className="project-media-gallery">
              {renderMedia("src/assets/projects/B2L 1.png", "B2L 1")}
              {renderMedia("src/assets/projects/B2L 2.png", "B2L 2")}
              {renderMedia("src/assets/projects/B2L 3.png", "B2L 3")}
              {renderMedia("src/assets/projects/B2L 4.png", "B2L 4")}
            </div>
          </div>
          ...
          <div className="project-card">
            ...
            <div className="project-media-gallery">
              {renderMedia("src/assets/projects/APPILY 1.mp4", "APPILY 1")}
              {renderMedia("src/assets/projects/APPILY 2.mov", "APPILY 2")}
              {renderMedia("src/assets/projects/APPILY 3.mp4", "APPILY 3")}
              {renderMedia("src/assets/projects/APPILY 4.mp4", "APPILY 4")}
            </div>
          </div>
          ...
          <div className="project-card">
            ...
            <div className="project-media-gallery">
              {renderMedia("src/assets/projects/HUG 1.mp4", "HUG 1")}
              {renderMedia("src/assets/projects/HUG 2.mp4", "HUG 2")}
              {renderMedia("src/assets/projects/HUG 3.png", "HUG 3")}
              {renderMedia("src/assets/projects/HUG 4.png", "HUG 4")}
            </div>
          </div>
          ...
          <div className="project-card">
            ...
            <div className="project-media-gallery">
              {renderMedia("src/assets/projects/PHI 1.png", "PHI 1")}
              {renderMedia("src/assets/projects/PHI 2.png", "PHI 2")}
              {renderMedia("src/assets/projects/PHI 3.png", "PHI 3")}
              {renderMedia("src/assets/projects/PHI 4.png", "PHI 4")}
            </div>
          </div>
        </div>
